...
#java -jar ../../pvesta/pvesta-client.jar -l ../../pvesta/serverlist -m seven_model_voip.maude -f tts.quatex
...
# --------------- Prank Call Attack - no SeVen (24.04.16) --------------#

java -jar ../../pvesta/pvesta-client.jar -l ../../pvesta/serverlist -m seven_prank_call_model_voip_pmod.maude -f client.quatex
java -jar ../../pvesta/pvesta-client.jar -l ../../pvesta/serverlist -m no_seven_prank_call_model_voip_pmod.maude -f attacker.quatex
java -jar ../../pvesta/pvesta-client.jar -l ../../pvesta/serverlist -m no_seven_prank_call_model_voip_pmod.maude -f availability.quatex
#java -jar ../../pvesta/pvesta-client.jar -l ../../pvesta/serverlist -m no_seven_prank_call_model_voip_pmod.maude -f availabilityINC.quatex
java -jar ../../pvesta/pvesta-client.jar -l ../../pvesta/serverlist -m no_seven_prank_call_model_voip_pmod.maude -f ddos.quatex
#java -jar ../../pvesta/pvesta-client.jar -l ../../pvesta/serverlist -m no_seven_prank_call_model_voip_pmod.maude -f tts.quatex
java -jar ../../pvesta/pvesta-client.jar -l ../../pvesta/serverlist -m no_seven_prank_call_model_voip_pmod.maude -f countAttackerCalls.quatex
java -jar ../../pvesta/pvesta-client.jar -l ../../pvesta/serverlist -m no_seven_prank_call_model_voip_pmod.maude -f countAttackerSucCalls.quatex
java -jar ../../pvesta/pvesta-client.jar -l ../../pvesta/serverlist -m no_seven_prank_call_model_voip_pmod.maude -f avgAttackerSucCalls.quatex
